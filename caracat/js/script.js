...
var seasons_cont = document.querySelector(".seasons_container");
var seasons_header = document.querySelector(".seasons_header");
var nature4 = document.querySelector(".nature_image_sea");
seasons_cont.addEventListener("mouseover", function (e) {
...
seasons_cont.addEventListener("mouseout", function (e) {
  if (e.target.classList.contains("nature_image_winter") || e.target.classList.contains("nature_image_summer") || e.target.classList.contains("nature_image_road")) {
